...
t0 = 0; tf = 2; N = 100; fx = 1; fy = 1; fr = 1; kapparef_straight = 0.0; kapparef_curve = 0.01; sf = 400; drf = 0; psirf = 0; t1 = tf/2; s1 = 200; %s1 = sf-2*pi/4*1/kapparef_curve; % Strecke, nach der von Gerade auf Kreis umgeschaltet wird
...
solinit = bvpinit(t,init_guess,[0.1 12 13]); % [nu_tilde, delta_t1, delta_t2]
