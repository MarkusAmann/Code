...
t0 = 0; t1 = 1; tf = 2; N = 100; fr = 1; fax = 1; fay = 1; fjx = 1; fjy = 1; kapparef_straight = 0.0; kapparef_curve = 0.01; sf = 300; s1 = 200; %s1 = sf-2*pi/4*1/kapparef_curve; % Strecke, nach der von Gerade auf Kreis umgeschaltet wird
drf = 0; psirf = 0;
