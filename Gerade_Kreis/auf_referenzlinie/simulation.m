...
alim = 1.06*1000; use_umax = 0;
umax = alim; umin = -alim;
t0 = 0; tf = 2; N = 100; fx = 1; fy = 1; fr = 1; kapparef_straight = 0; kapparef_curve = 0.15; sf = 30; drf = 0; psirf = 0; t1 = tf/2; s1 = 15; %s1 = sf-2*pi/4*1/kapparef_curve; % Strecke, nach der von Gerade auf Kreis umgeschaltet wird
...
solinit = bvpinit(t,init_guess,[0.6 2 5]); % [nu_tilde, delta_t1, delta_t2]
