...
H_tf = 1/2*p.fx*jf^2 + 1/2*p.fy*kappaf^2*vf^4 + l1f*vf + l2f*axf + l3f*jf;
H_L = 1/2*p.fx*jL^2 + 1/2*p.fy*kappaL^2*vL^4 + l1L*vL + l2L*axL + l3L*jL;
H_R = 1/2*p.fx*jR^2 + 1/2*p.fy*kappaR^2*vR^4 + l1R*vR + l2R*axR + l3R*jR;
