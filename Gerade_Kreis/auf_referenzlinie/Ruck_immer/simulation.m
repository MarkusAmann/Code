...
jlim = 3; use_umax = 0;
umax = jlim; umin = -jlim;
t0 = 0; t1 = 1; tf = 2; N = 100; fx = 1; fy = 1; fr = 1; kapparef_straight = 0.0; kapparef_curve = 0.1; sf = 100; s1 = 60; %s1 = sf-2*pi/4*1/kapparef_curve; % Strecke, nach der von Gerade auf Kreis umgeschaltet wird
