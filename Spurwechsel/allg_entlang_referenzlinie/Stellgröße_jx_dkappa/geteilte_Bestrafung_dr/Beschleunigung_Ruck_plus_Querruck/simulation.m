...
t0 = 0; t1 = 1; tf = 2; N = 100; fr = 1; fax = 1; fay = 1; fjx = 1; fjy = 1; kapparef = 0.0; sf = 300; s1 = sf/2; drf = 3.5; psirf = 0; dr1 = 3.5;
x0 = [0 30 0 0 0 kapparef].'; l0 = [0 0 0 0 0 0].'; %l0 = 0.1*randn(4,1);
...
J_fun = 1/2*p.fjx*jopt.^2 + 1/2*p.fax*aopt.^2 + 1/2*p.fjy*jyopt.^2 + 1/2*p.fay*kappaopt.^2.*vopt.^4 + [1/2*p.fr*dropt(1:split_idx(1)).^2 1/2*p.fr*(dropt(split_idx(2):end)-p.dr1).^2*p.use_dr_min_dr1];
