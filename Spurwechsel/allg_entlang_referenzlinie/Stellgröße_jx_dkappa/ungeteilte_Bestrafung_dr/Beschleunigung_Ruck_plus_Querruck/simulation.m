...
t0 = 0; t1 = 1; tf = 2; N = 100; fr = 1; fax = 1; fay = 1; fjx = 1; fjy = 1; kapparef = 0.0; sf = 500; s1 = 150; drf = 1; psirf = 0; dr1 = 1;
x0 = [0 1 0 0 0 kapparef].'; l0 = [0 0 0 0 0 0].'; %l0 = 0.1*randn(4,1);

p.use_umax = use_umax; p.umax = umax; p.umin = umin; p.use_dr = use_dr; p.fr = fr; p.fax = fax; p.fay = fay; p.fjx = fjx; p.fjy = fjy; p.kapparef = kapparef;  
