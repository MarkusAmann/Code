...
H_L = 1/2*p.fa*aL^2 + 1/2*p.fj*jL^2 + delta_t1*(l1L*vL + l2L*aL + l3L*jL);
...
res = [X0(1) - p.x0(1);...
    ...
    X_internalGNB_L(4) - X_internalGNB_R(4) - nu_tilde;... % Transversalitätsbedingung für l3 (l3(t1-) = l3(t1+) + dg/dx|t1*nu_tilde)
    X_internalGNB_L(5:6) - X_internalGNB_R(5:6);... % Stetigkeit am internen Randwert
