...
H_tf = 1/2*p.fa*af^2 + 1/2*p.fj*jf^2 + delta_t1*(l1f*vf + l2f*af + l3f*jf);
...
res = [X0(1) - p.x0(1);...
    ...
    X_internalGNB_L(4) - X_internalGNB_R(4) - nu_tilde;... % Transversalitätsbedingung für l1 (l1(t1-) = l1(t1+) + dg/dx|t1*nu_tilde)
