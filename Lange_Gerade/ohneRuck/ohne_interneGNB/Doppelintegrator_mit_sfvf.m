...
h = 100; v0 = 10; f = 1; vf = 20;
[t,s,v,a,p] = double_int(h,f,v0,vf);
figure
subplot(3,1,1)
plot(t,s)
ylabel('s [m]')
...
function [t,s,v,a,p] = double_int(h,f,v0,vf)
% ----------------------------------------------------
...
% p: Parameterstruktur
p.f = f; % Parameter
p.s0=0; p.v0=v0; p.vf=vf;% Anfangsbedingungen
...
H_tf = l1*vfct(l1,a0,tf,p) - 1/2*p.f*afct(l1,a0,tf,p)^2;
