...
switch p.use_dr
    case 1
        ...
        f = [0;...
            -(2*p.fay*v^3*kappa^2 + 2*p.fjy*dkappa^2*v^3 + 4*p.fjy*kappa*a^2*v + 6*p.fjy*kappa*a*v^2*dkappa + l1*cos(psir)/(1-dr*p.kapparef) + l4*sin(psir) + l5*kappa - l5*p.kapparef*cos(psir)/(1-dr*p.kapparef));...
            -(p.fax*a + 4*p.fjy*kappa*a*v^2 + 2*p.fjy*kappa*v^3*dkappa + l2);...
            ...
            -(p.fay*kappa*v^4 + 2*p.fjy*a^2*v^2 + 2*p.fjy*a*v^3*dkappa + l5*v)];
    case 0
