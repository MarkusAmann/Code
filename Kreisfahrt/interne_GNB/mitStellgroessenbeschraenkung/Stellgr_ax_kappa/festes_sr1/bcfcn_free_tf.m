...
res = [X0(1) - p.x0(1);... % Anfangswerte
    ...
    l3f;...
    l4f;...
    X_internalGNB_L(1:4) - X_internalGNB_R(1:4);... % Stetigkeit am internen Randwert
    X_internalGNB_L(5) - X_internalGNB_R(5) - nu_tilde;... % Transversalitätsbedingung für l1 (l1(t1-) = l1(t1+) + dg/dx|t1*nu_tilde)
    X_internalGNB_L(6:8) - X_internalGNB_R(6:8);...
    X_internalGNB_L(1) - p.sr1;... % zusätzliche interne Randbedingung
    Hf + 1];
