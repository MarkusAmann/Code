% J = int(1/2*fp*psir^2 + 1/2*fx*ax^2 + 1/2*fy*kappa^2*v^4))
...
eqns = [kappa*v - kappar*v/(1-dr*kappar);...
    ...
    -(l1 - kappar*l4);...
    -(fp*psir + l3*v + l4*v*psir/(1-dr*kappar) - l1*v*psir*kappar/(1-dr*kappar));...
    kappa + l4/(fy*v^3);...
    1/2*fp*psir^2 + 1/2*fy*kappa^2*v^4 + l1*v/(1-dr*kappar) + l3*v*psir + l4*kappa*v - l4*kappar*v/(1-dr*kappar) + 1];
